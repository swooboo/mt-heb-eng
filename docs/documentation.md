...
Statistical translation model training is described in-depth in the [training_instructions.md](https://github.com/swooboo/mt-heb-eng/blob/staging/docs/training_instructions.md) file. Actually, one can follow the instructions there, and get a translation model. The tutorial is semi-automatic, meaning only copy-paste and execution needed, almost no human intervention.
